...
public class EventManager {
    ...
    public static void load() {
        ...
        updateMessage(ServerUtil.getTextChannel(ServerUtil.getChannelID("game_info")));
    }
    ...
    public static void updateMessage(TextChannel channel) {
        ...
        channel.editMessageEmbedsById(ServerUtil.getMessageID("game_event"),eb.build()).queue();
    }
