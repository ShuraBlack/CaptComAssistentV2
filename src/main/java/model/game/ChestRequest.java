...
import static util.ServerUtil.BLUE;
        ...
        return chestRequest -> {
            ...
            while(chest < chestRequest.getRoyal()) {
                ...
                if (royalChance < 840) {
                    ...
                    if (chestRequest.getCreator().getAvaiableDecks().contains("ROYAL") || chestRequest.getDecks().contains("ROYAL")) {
        ...
        return chestRequest -> {
            ...
            while(chest < chestRequest.getJewel()) {
                ...
                if (jewelChance < 700) {
                    ...
                    if (chestRequest.getCreator().getAvaiableDecks().contains("JEWEL") || chestRequest.getDecks().contains("JEWEL")) {
        ...
        return chestRequest -> {
            ...
            while(chest < chestRequest.getElegant()) {
                ...
                if (elegantChance < 750) {
                    ...
                    if (chestRequest.getCreator().getAvaiableDecks().contains("ELEGANT") || chestRequest.getDecks().contains("ELEGANT")) {
