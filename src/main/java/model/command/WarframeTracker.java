...
public class WarframeTracker implements ServerCommand {
    ...
    public void performTextChannelCommand(Member member, TextChannel channel, String message) {
        ...
        if (args.length == 2) {
            switch (args[1]) {
                case "cycle":
                    trackerMessage(channel);
                    break;
                case "arbi":
                    arbitrationMessage(channel);
                    break;
                case "construct":
                    constructionProgressMessage(channel);
                    break;
                case "sortie":
                    sortieMessage(channel);
                    break;
                case "nightwave":
                    nightwaveMessage(channel);
                    break;
                case "voidtrader":
                    voidTraderMessage(channel);
                    break;
            }
